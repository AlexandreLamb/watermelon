        ...
        return(
            <div>
                        <Nav variant="tabs" defaultActiveKey="infoCard" >
                            <Nav.Item>
                                <Nav.Link onClick={this.updateNav.bind(this, "infoCard")} >Info Card</Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link onClick={this.updateNav.bind(this, "updateCard")} > Update Card</Nav.Link>
                            </Nav.Item>
                            </Nav> 
               <DisplayCard
                cvc={this.props.cvc}
