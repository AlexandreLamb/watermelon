...
class CardList extends Component {
    ...
    render(){
        return(
            <div>
                <ListCards cards={this.props.cards} deleteCard={this.deleteCard} onChangeCard={this.props.onChangeCard}/>
            </div>
        )
    }
        ...
        <ListGroup>
                ...
                (
                    <ListGroupItem key={card.id}>             
                        <Button variant="danger" size="sm" onClick={props.deleteCard.bind(this, card)}>X</Button>
                        <CardItem
                        cvc={card.last_4}
